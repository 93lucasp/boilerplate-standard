...
gulp.task('public', gulpSequence('clean', 'build-sass', 'autoprefixer-css', 'minify-css', 'copy-images', 'concat-js', 'build-hbs', 'html-replace'));
gulp.task('default', gulpSequence('build-sass', 'autoprefixer-css', 'build-js-vendors', 'copy-js', 'copy-images', 'build-hbs', 'serve'));